    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {/* Projects & Assistance */}
          <div className="bg-[#541D67] text-white p-8 rounded-lg">
            <div className="mb-4">
            ...
            <h3 className="text-2xl font-bold mb-4">Projects & Assistance</h3>
            <p>SACKOBA is committed to assist the management in the highly complex operation of running the School.</p>
          </div>

          {/* The Committee */}
          <div className="bg-[#B62D71] text-white p-8 rounded-lg">
            <div className="mb-4">
              <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-2xl font-bold mb-4">The Committee</h3>
            <p>We perpetuate the tradition of the Alma Mater beyond the precincts of the classroom.</p>
          </div>

          {/* Membership */}
          <div className="bg-[#9A78AB] text-white p-8 rounded-lg">
            <div className="mb-4">
              <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p>Please fill the membership form and send the same to The Secretary via email / post.</p>
          </div>
        </div>
